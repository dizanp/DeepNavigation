package com.deepnavigation.mydeepnavigation;
...
public class MainActivity extends AppCompatActivity  implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_open_detail){
            ...
            detailIntent.putExtra(DetailActivity.EXTRA_MESSAGE, "Now You can learn");
    ...
    private class DelayAsync extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPostExecute(Void aVoid){
            ...
            showNotification(MainActivity.this, "Hi, how are you?",
                    "Do you have any plan this? Let's hangout", 110);
        }
    }
    ...
    private void showNotification(Context context, String title, String message, int notifId){
        ...
        NotificationCompat.Builder builder = new
                ...
                .setSmallIcon(R.drawable.ic_email_black_24_dp)
